...
const RegisterPage = () => {
    ...
    return (
        ...
        <div className="px-4 w-full pb-10">
            {/* MODIF : p-6 et mt-4 sur mobile, p-8 et mt-10 sur desktop */}
            <div className="max-w-md mx-auto bg-viking-rock/90 p-6 md:p-8 rounded-lg border-2 border-viking-gold shadow-2xl backdrop-blur-sm mt-4 md:mt-10">
                {/* MODIF : text-2xl sur mobile */}
                <h2 className="text-2xl md:text-3xl font-dragon text-viking-gold mb-6 md:mb-8 text-center uppercase tracking-widest">
                    Rejoindre la Guilde
                </h2>
