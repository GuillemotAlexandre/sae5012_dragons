 ...
 */
final class Version20251208145945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, value INT NOT NULL, author_id INT NOT NULL, article_id INT NOT NULL, INDEX IDX_D8892622F675F31B (author_id), INDEX IDX_D88926227294869C (article_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
