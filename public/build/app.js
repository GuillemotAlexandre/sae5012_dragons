    ...
    react__WEBPACK_IMPORTED_MODULE_42___default().createElement("form", {
      ...
      return (
        ...
        react__WEBPACK_IMPORTED_MODULE_42___default().createElement("div", {
          ...
          className: "bg-white/20 border border-stone-800 flex items-center justify-center min-h-[200px] rounded p-2 overflow-hidden"
